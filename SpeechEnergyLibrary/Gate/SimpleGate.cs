...
using SpeechEnergyLibrary.Envelope;

namespace SpeechEnergyLibrary.Gate
{
    public class SimpleGate : AttackReleaseEnvelope
    {
        // transfer function
        ...
        public SimpleGate(double attackMilliseconds, double releaseMilliseconds, double sampleRate) : base(attackMilliseconds, releaseMilliseconds, sampleRate)
        { }
        ...
        public void Process(ref double inValue)
        {
            // call to Process with same in value
            this.Process(ref inValue, ref inValue);
        }
